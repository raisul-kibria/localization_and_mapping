...
class ParticleFilter():
    ...
    def plot_data(self):
        ...
        # Particles
        plt.scatter(self.particles[:, 0], self.particles[:, 1], s=40, c='orange', alpha=0.8, label="Particles")
        plt.scatter(self.particles_log[:, 0], self.particles_log[:, 1], s=0.5, c='k', alpha=0.5, label="Particles log")
