...
class DeadReckoning():
    def __init__(self, dataset, robot, end_frame):
    ...
    def motion_update(self, control, num=50):
        # State: [x, y, θ]
        # Control: [v, w]
    ...
    def build_dataframes(self):
        ...
        self.motion = measurements[measurements.type == -1].rename(columns={'range_l': 'v', 'bearing_l': 'omega'})
